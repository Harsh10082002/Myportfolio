...
//                         <i className="bx bxs-location-plus text-blue-500 text-2xl"></i>
//                         <div>
...
//                         <button className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-300">Send</button>
//                     </form>
//                     {errStatus ? <p className="text-red-500 mt-2">{successFullMsg}</p> : <p className="text-green-500 mt-2">{successFullMsg}</p>}
//                 </div>
//             </div>
//         </div>
//     </>
