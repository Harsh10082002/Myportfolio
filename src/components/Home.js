...
//                     <div className=" my-8 ">
//                         <p className="py-2 font-semibold text-lg text-[#173b6c]">
//                         Hi there! My name is Harsh Chouksey and I'm an Engineering student
//                         of Final year. I love doing coding and building web applications. I am good 
//                         in C++, and Development. 
...
//                     <img className=" w-[900px] rounded-full"  src={require("../image/h3.jpeg")}>
//                     </img>
//                 </div>
//             </div>
//         </div>
